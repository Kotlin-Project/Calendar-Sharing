...
class FriendScheduleAdapter(private var scheduleList: List<UserCalendar>) :
    RecyclerView.Adapter<FriendScheduleAdapter.ViewHolder>() {
        ...
        init {
            ...
            itemView.setOnClickListener {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    ...
                    val intent = Intent(itemView.context, FriendDetailSchedule::class.java)
